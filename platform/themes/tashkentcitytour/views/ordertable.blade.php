            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-md-5 col-md-offset-1">
                    <div class="radio">
                        <label class="radio-custom" data-initialize="radio">
                            ...
                            {{ __('Оплата через') }}<span class="visible-xs-inline">Payme</span>
                        </label>
                        <img src="/images/img/click.jpg" alt="Click" class="hidden-xs" />
                    </div>
                </div>
                <div class="col-xs-6 col-md-5 col-mda-offset-1">
                    <div class="radio">
                        ...
                        <img src="/images/img/card.jpg" alt="Card" class="hidden-xs" />
                    </div>
                </div>
            </div>
        </div>
...
<div class="highlight hidden" id="pay-method-card">
    <div class="box">
        <div class="row margin-b">
            <div class="col-sm-3">
                <img src="/images/img/visa-master-card.jpg" alt="" />
            </div>
            <div class="col-sm-9">
