...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family={{ urlencode(theme_option('primary_font', 'Montserrat+Alternates')) }}" rel="stylesheet" type="text/css">
        <!-- CSS Library-->

        <style>
            :root {
                --color-1st: {{ theme_option('primary_color', '#bead8e') }};
                --primary-font: '{{ theme_option('primary_font', 'Montserrat+Alternates') }}', sans-serif;
            }
        </style>
        {!! Theme::header() !!}
